		...
		concat: {
			css: {
				src: ['_gh_pages/assets/css/font-awesome.min.css',
					...
					'_gh_pages/assets/css/dataTables.bootstrap.min.css'
				],

				dest: '_gh_pages/dist/css/nflfines.css'
			},
			js: {
				options: {
					separator: ';',
				...
				src: ['_gh_pages/assets/js/jquery.min.js',
					...
					'_gh_pages/assets/js/jquery.dataTables.min.js',
					'_gh_pages/assets/js/dataTables.bootstrap.min.js',
					'_gh_pages/assets/js/site.js'
				],

				dest: '_gh_pages/dist/js/nflfines.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/nflfines.css',
				dest: '_gh_pages/dist/css/min/nflfines.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/nflfines.js',
				dest: '_gh_pages/dist/js/min/nflfines.min.js'
			}
		},
		watch: {
			css: {
